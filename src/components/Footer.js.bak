...
export function Footer() {
  return (
    <section className="bg-[#02040F] pt-20 px-4 md:px-16 lg:px-24 xl:px-36">
      <div className="mx-auto max-w-[1440px]">
        <div className="flex flex-col md:flex-row justify-around justify-items-stretch">
          <div className="flex flex-row justify-around">
            <div className="mr-20 flex flex-col justify-around">
          ...
          <div className="my-auto pb-20">
            ...
            <h4 className="text-lg italic text-center font-medium text-white my-1 opacity-80">
              Samrala Road (Dist. Ludhiana)
            </h4>
            <h4 className="text-lg italic text-center font-regular text-white my-1 opacity-80">
              091-01628-228470 / 225170
            </h4>
            <div className="flex flex-row justify-evenly">
              <a href="#facebookpage">
                <svg
                  ...
                  width="30px"
                  height="30px"
                  className="grayscale-[1] hover:grayscale-0"
                >
                  <linearGradient
        ...
        <div className="w-screen md:w-11/12 lg:w-5/6 h-10 rounded-t-md mx-auto flex flex-row justify-evenly text-white pt-2">
          <h4>Footer Val1</h4>
          <h4>Footer Val1</h4>
          <h4>Footer Val1</h4>
        </div>
