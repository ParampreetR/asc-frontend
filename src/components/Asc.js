    ...
    <div className="my-16 mx-8  md:mx-16 lg:mx-24 xl:mx-36">
      <div className="max-w-[1440px] mx-auto">
        ...
        <p className="text-xl text-justify">
          ...
          It has been shaping its curiculor and administrative performance
          eeping pace with the emerging trends in higher education. New courses
          have been incorporated in its curricular framework from time to time
          to fulfill the aspiration and needs of students. Many pass out
          students of this college are enjoying the enviable positions in their
          fields.
        </p>
      </div>
    </div>
