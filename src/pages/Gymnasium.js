  ...
  return (
    <div className="my-12 mx-8  md:mx-16 lg:mx-24 xl:mx-36">
      <div className="max-w-[1440px] mx-auto">
        ...
        <h1 className="text-center text-2xl text-[#003060] mt-6 md:text-3xl my-2 md:my-4 text-[#141E27] font-bold">
          Indoor GYM
        </h1>
        ...
        />
        <h1 className="text-center text-2xl text-[#003060] md:text-3xl my-2 md:my-4 text-[#141E27] font-bold">
          Badminton Court
        </h1>
        <p className="text-black text-center font-bold text-lg my-1 text-md md:text-lg mt-2 dark:text-white">
