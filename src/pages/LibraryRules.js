    ...
    <div className="my-12 mx-8  md:mx-16 lg:mx-24 xl:mx-36">
      <div className="max-w-[1440px] mx-auto">
        ...
        <p className="text-white  text-white  my-5 text-md md:text-lg bg-gradient-to-b from-primary to-primary2 dark:from-primary_dark dark:to-primary2_dark rounded-md shadow-xl py-6 px-10 md:px-12 lg:px-16">
          ...
          collection of more than 50,000 books which include textbooks,
          reference books, general books and non-book materials. The Library
          collection is well classified, catalogued in a Systematic way. The
          College Library is enriched with 30 Journals, 20 magazines and 12
        ...
        <ol
          className="list-decimal text-xl text-white my-5 bg-gradient-to-b
        ...
        >
          ...
          <p class="text-lg">
            ...
            use is a major public service provided by the library. All the
            members of the library visit this section for getting books on loan
            for home use.
          </p>
          ...
          <p class="text-lg">
            ...
            and disseminate the information the library has acquired. Reference
            service fulfils this last function. Library provides assistance in
